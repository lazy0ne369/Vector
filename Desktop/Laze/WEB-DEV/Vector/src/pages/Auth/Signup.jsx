      ...
      <div className={`auth-container auth-container-signup ${isAnimating ? 'slide-in-right' : ''}`}>
        <div className="auth-card">
          ...
          <div className="auth-divider">
            <span>{t('auth.orSignUpEmail')}</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="form-group">
              <label className="form-label">{t('auth.phoneOptional')}</label>
              <div className="input-icon">
                <Phone size={18} />
                <input
                  type="tel"
            ...
            <label className="checkbox-label terms">
              ...
              <span>{t('auth.agreeTerms')} <Link to="/terms">{t('auth.termsOfService')}</Link> {t('auth.and')} <Link to="/privacy">{t('nav.privacy')}</Link></span>
            </label>
